...
export class BookmarkedListingsComponent {
  ...
  constructor(private backendService: BackendService, private angularFireAuth: AngularFireAuth,
     private apiService: ApiService, private savesRetrieval: SavesRetrieval){}
